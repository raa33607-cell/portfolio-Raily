# portfolio-Raily
мой портфолио 
[index.html](https://github.com/user-attachments/files/21957346/index.html)
<!DOCTYPE html>
<html lang="ru">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Портфолио — Мазитова Райля</title>
  <style>
    body {font-family: Arial, sans-serif; margin: 0; padding: 0; background: #fdfdfc; color: #333;}
    header {position: fixed; top: 0; left: 0; right: 0; background: #fff; display: flex; justify-content: space-between; align-items: center; padding: 15px 40px; box-shadow: 0 2px 6px rgba(0,0,0,0.1); z-index: 1000;}
    header nav a {margin: 0 15px; text-decoration: none; color: #333; font-weight: bold;}
    header .lang-select select {padding: 5px; border-radius: 5px; border: 1px solid #ccc;}
    section {padding: 100px 40px; max-width: 1000px; margin: auto;}
    .hero {text-align: center; padding-top: 80px;}
    .hero h1 {font-size: 2.5rem; margin-bottom: 10px;}
    .hero h2 {font-size: 1.2rem; margin-bottom: 20px; color: #666;}
    .hero .buttons a {display: inline-block; margin: 10px; padding: 12px 25px; background: #d4a373; color: white; text-decoration: none; border-radius: 8px;}
    .about {display: flex; align-items: center; gap: 30px;}
    .about img {max-width: 250px; border-radius: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);}
    .skills {margin-top: 20px;}
    .skills ul {list-style: none; padding: 0; display: flex; flex-wrap: wrap; gap: 15px;}
    .skills li {background: #eee; padding: 8px 15px; border-radius: 6px;}
    .projects {display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;}
    .project-card {background: #fff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden;}
    .project-card img {width: 100%; height: auto;}
    .project-card .content {padding: 15px;}
    .contact {text-align: center;}
    .contact a {margin: 0 10px; text-decoration: none; font-size: 1.5rem;}
...
<body>
  <header>
    <nav>
      <a href="#about" data-lang="nav-about">Обо мне</a>
      <a href="#projects" data-lang="nav-projects">Проекты</a>
      <a href="#contact" data-lang="nav-contact">Контакты</a>
    </nav>
